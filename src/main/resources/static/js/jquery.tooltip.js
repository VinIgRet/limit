			...
			if(!$(this).hasClass("notooltip")&&h.length>0){
				$(this).bind("mouseover mousemove",function(e){
					if(h){
						...
						if($("#tooltip").width()>300){$("#tooltip").css({"width": "300px"});}
						...
						if(e.type=="mouseover"){show=window.setTimeout(function(){$("#tooltip").fadeIn(300).show().css({"top":o.top+"px","left":o.left+"px"});},delay);}
						if(e.type=="mousemove"){$("#tooltip").css({"top":o.top+"px","left":o.left+"px"});}
					}
				});
				$(this).mouseout(function(e){
					$("#tooltip").hide();$("#tooltip").css({"width":""});
